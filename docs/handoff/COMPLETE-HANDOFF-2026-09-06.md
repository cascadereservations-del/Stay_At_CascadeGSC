...
> **Superseded after P3.** Use [COMPLETE-HANDOFF-P3-2026-09-06.md](./COMPLETE-HANDOFF-P3-2026-09-06.md). P0–P3 are complete; P4 recovery and the 72-hour dormant soak are next. The older P2-era status below is retained only as historical context.
