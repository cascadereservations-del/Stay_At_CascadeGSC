...
This React/Vite project is the editable source for the dashboard design artifact in the parent directory. It uses sample data only and has no Supabase, n8n, Telegram, bank, or guest-channel integration.
