-- Guest CRM hardening (admin session 15, 2026-09-14). Generated from
-- admin-dashboard/scripts/prepare-crm-hardening.mjs; every preserved branch was
-- diffed against the live Cascade definitions on 2026-09-14 before packaging.
-- Four function bodies replaced with identical signatures, guest-id-photos bucket
-- gains a size/MIME limit, and its three storage policies become guest/property
-- scoped. No rows or objects are rewritten. Rollback: rollbacks/20260914_guest_crm_hardening.sql
begin;
