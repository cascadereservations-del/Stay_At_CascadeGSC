-- Compensating rollback for release rate_card_upcoming_20260926: the two functions as release rate_card_20260926
-- left them (no `upcoming`; the hold stamps the card in force today). pricing.ts treats a missing `upcoming` as none.
begin;
