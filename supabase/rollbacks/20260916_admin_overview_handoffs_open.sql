-- Compensating rollback for 20260916150000_admin_overview_handoffs_open.sql: restores get_admin_overview_v1 from
-- 20260915000000_admin_overview_missed_cleaning.sql and run_health_checks_v1 from
-- 20260914210000_run_health_checks_v1_fix.sql. Read-only functions; nothing else changes.
begin;
