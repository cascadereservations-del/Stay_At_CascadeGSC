-- Compensating rollback for 20260914250000_admin_audit_feed_v2.sql.
-- Restores admin_audit_feed_v1 to the body from 20260914200000_admin_crud_audit_v1.sql
-- (drops the staff_details / companion union branches; no data changed either way).
begin;
