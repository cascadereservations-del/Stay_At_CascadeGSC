-- Compensating rollback for 20260915000000_admin_overview_missed_cleaning.sql.
-- Restores get_admin_overview_v1 to the body from 20260913100000_admin_read_models_v1.sql
-- (drops the v_missed_days lookup, the 'overdue' readiness state, 'daysOverdue' field, and
-- the missed_cleaning action). No data changed either way -- read-only function only.
begin;
